...
@Api(value = "/resident",description = "用户信息",produces = MediaType.APPLICATION_JSON_VALUE)
@RestController
@RequestMapping(value = "/resident")
public class BscresidentController extends BaseController<Bscresident>{
    @Override
    @ApiOperation(value="获取单个用户", notes="" ,response = Bscresident.class)
    ...
    @Override
    @ApiOperation(value="查询用户总条数", notes="",response = Integer.class)
    ...
    @Override
    @ApiOperation(value="根据条件查询用户个数", notes="",response = Integer.class)
    ...
    @Override
    @ApiOperation(value="根据条件查询多个用户", notes="",response = Bscresident.class)
    ...
    @Override
    @ApiOperation(value="根据id查找是否存在", notes="",response = Boolean.class)
    ...
    @Override
    @ApiOperation(value="根据条件查询用户是否存在", notes="",response = Boolean.class)
    ...
    @Override
    @ApiOperation(value="保存单个用户", notes="",response = Bscresident.class)
    ...
    @Override
    @ApiOperation(value="根据id删除单个用户", notes="",response = Integer.class)
    ...
    @Override
    @ApiOperation(value="根据条件删除单个用户", notes="",response = Integer.class)
    ...
    @Override
    @ApiOperation(value="根据条件删除多个用户", notes="",response = Integer.class)
